...
local function rowToLocker(row)
    return {
        ...
        key_consume = Lockers.RowBool(row, 'key_consume'),
        ...
        auto_restock = Lockers.RowBool(row, 'auto_restock'),
        restock_interval = row.restock_interval,
        enabled = Lockers.RowBool(row, 'enabled'),
...
local function rowToItem(row)
    return {
        ...
        returnable = Lockers.RowBool(row, 'returnable'),
        unlimited = Lockers.RowBool(row, 'unlimited'),
        cooldown = row.cooldown,
        locker_cooldown = row.locker_cooldown,
        price = row.price,
        deposit = row.deposit,
        personal_bind = Lockers.RowBool(row, 'personal_bind'),
